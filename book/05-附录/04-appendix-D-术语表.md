...
| 3-4-3 | 三类角色、四大动态工件、三条运行原则构成的最小治理内核 |
| IO | 意图主理人，负责价值、取舍和签署 |
| OA | 编排架构师，负责治理设计和异常升级 |
| AS | 在授权边界内执行的自治蜂群 |
| Intent Graph | 全局意图、依赖和知识导航 |
...
| Work Graph | 描述任务依赖和执行关系的 DAG |
| HITL | 需要人类承担判断或批准责任的介入点 |
| Context Engineering | 设计 Agent 可获得的上下文、边界、来源和新鲜度，而不只是堆叠提示词 |
| Graph Engineering | 用图结构表达意图、工作、证据和依赖，使并行执行与追溯成为可能 |
| Loop Engineering | 设计观察、行动、验证、恢复和升级循环，使自治可持续运行 |
...
| RACI-D | 在传统责任分工上显式增加 Decision Owner，确保关键裁决由有权承担后果的人作出 |
